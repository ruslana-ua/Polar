    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".swiper", {
                ...
                speed: 800,
                pagination: {
                    el: ".wrapper-reviews__pagination",
                    clickable: true
                },
                navigation: {
            ...
            let mainsliderImages = document.querySelectorAll(".wrapper-reviews__avatar");
            let mainsliderDotts = document.querySelectorAll(".wrapper-reviews__pagination .swiper-pagination-bullet");
